...
class PropertyService:
    ...
    def _process_data(cls, **kwargs: dict) -> dict:
        ...
        return {
            ...
            "lot_size_acres": provider_2_data.get("LotSizeAcres", sqft_to_acre(provider_1_data.get("SquareFootage", 0))),
            ...
            "room_count": provider_2_data.get("RoomCount") or provider_1_data.get("features", {}).get("roomCount"),
            "septic_system": provider_2_data.get("SepticSystem") or provider_1_data.get("features", {}).get("septicSystem"),
